...
import com.appgenesis.com.maintenanceapp.technician.activity.TechnicianBreakDownRequestDetailActivity
import com.appgenesis.com.maintenanceapp.technician.activity.TechnicianMaintenanceRequestDetailActivity
import com.appgenesis.com.maintenanceapp.technician.activity.TechnicianPreventiveRequestDetailActivity

class TechnicianClosedRequestAdapter(val mContext: Context?,
                                     val licenceList: ArrayList<BreakdownRequest>, val type:String)
    : RecyclerView.Adapter<TechnicianClosedRequestAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        if (type.equals("breakdown")) {
            holder.itemView.setOnClickListener {
                val intent = Intent(mContext, TechnicianBreakDownRequestDetailActivity::class.java)
        ...
        if (type.equals("mr")) {
            holder.itemView.setOnClickListener {
                val intent = Intent(mContext, TechnicianMaintenanceRequestDetailActivity::class.java)
                intent.putExtra("request_id", (licenceList[holder.adapterPosition].id).toString())
                mContext!!.startActivity(intent)
            }
        }
        if (type.equals("preventive")) {
            holder.itemView.setOnClickListener {
                val intent = Intent(mContext, TechnicianPreventiveRequestDetailActivity::class.java)
                intent.putExtra("request_id", (licenceList[holder.adapterPosition].id).toString())
                mContext!!.startActivity(intent)
            }
        }
