...
class ManagementMaintenanceRequestActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_management_maintenance_request)
        ...
        if (intent1 != null) {
            ...
            if (type == "preventive") {
                ...
                supportActionBar!!.title="Maintenance Requests"
            }
        }
        val bundle = Bundle()
