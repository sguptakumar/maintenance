...
class OperationManagerBreakdownrequestDetailActivity : AppCompatActivity() {
    ...
    private fun commmentObserver(): Observer<MainResponseModel> {
        return object : Observer<MainResponseModel> {
            ...
            override fun onNext(t: MainResponseModel) {
                ...
                Toast.makeText(this@OperationManagerBreakdownrequestDetailActivity,"Comment is successfully",Toast.LENGTH_SHORT).show()
