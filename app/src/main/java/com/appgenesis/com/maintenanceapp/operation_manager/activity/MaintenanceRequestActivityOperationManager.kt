...
import kotlinx.android.synthetic.main.activity_maintenance_request_operation_manager.*
...
class MaintenanceRequestActivityOperationManager : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_maintenance_request_operation_manager)
