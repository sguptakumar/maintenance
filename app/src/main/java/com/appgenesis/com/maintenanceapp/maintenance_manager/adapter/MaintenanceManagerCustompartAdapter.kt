...
class MaintenanceManagerCustompartAdapter(val mContext: Context?, val licenceList: ArrayList<CustomPart>):
    RecyclerView.Adapter<MaintenanceManagerCustompartAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, p1: Int): MaintenanceManagerCustompartAdapter.MyViewHolder {
        val itemView = LayoutInflater.from(parent.context)
            .inflate(R.layout.orederpartlayout, parent, false)
        return MaintenanceManagerCustompartAdapter.MyViewHolder(itemView)
    }
