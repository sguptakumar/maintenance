...
class OperationManagerPreventiverequestDetailActivity : AppCompatActivity() {
    ...
    private fun commmentObserver(): Observer<MainResponseModel> {
        return object : Observer<MainResponseModel> {
            ...
            override fun onNext(t: MainResponseModel) {
                ...
                Toast.makeText(this@OperationManagerPreventiverequestDetailActivity,"Comment is successfully",Toast.LENGTH_SHORT).show()
