...
class MaintenanceManagementPreventiveRequestDetailActivity : AppCompatActivity() {
    ...
    private fun commmentObserver(): Observer<MainResponseModel> {
        return object : Observer<MainResponseModel> {
            ...
            override fun onNext(t: MainResponseModel) {
                ...
                Toast.makeText(this@MaintenanceManagementPreventiveRequestDetailActivity,"Comment is successfully",Toast.LENGTH_SHORT).show()
    ...
    private fun technicianlistObserver(): Observer<TechnicianListResponse> {
        return object : Observer<TechnicianListResponse> {
            ...
            override fun onNext(t: TechnicianListResponse) {
             ...
             val arrayAdapter = ArrayAdapter(this@MaintenanceManagementPreventiveRequestDetailActivity, android.R.layout.simple_spinner_item, technicianlist)
    ...
    private fun breakdownRequestObserver(): Observer<BreakdownRequestResponse> {
        return object : Observer<BreakdownRequestResponse> {
            ...
            override fun onNext(breakdownRequestResponse: BreakdownRequestResponse) {
                ...
                var orderresponse= breakdownRequestResponse.preventiveRequest!!.orders
            ...
            override fun onError(e: Throwable) {
                myLoader.dismiss()
                Toast.makeText(this@MaintenanceManagementPreventiveRequestDetailActivity,""+e,Toast.LENGTH_SHORT).show()
            }
