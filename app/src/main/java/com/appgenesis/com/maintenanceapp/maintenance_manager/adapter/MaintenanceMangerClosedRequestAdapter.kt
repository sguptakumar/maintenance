...
import com.appgenesis.com.maintenanceapp.maintenance_manager.activity.MaintenanceManagementBreakdownRequestDetailActivity
import com.appgenesis.com.maintenanceapp.maintenance_manager.activity.MaintenanceManagementMaintenanceRequestDetailActivity
import com.appgenesis.com.maintenanceapp.maintenance_manager.activity.MaintenanceManagementPreventiveRequestDetailActivity
...
class MaintenanceMangerClosedRequestAdapter(
    val mContext: Context?,
    private val breakdownRequestList: ArrayList<BreakdownRequest>, var type: String
) : RecyclerView.Adapter<MaintenanceMangerClosedRequestAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        ...
        sharedpreferences = SharedPreferenceUtils.getInstance(this!!.mContext!!)
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        if (type.equals("breakdown")) {
            holder.itemView.setOnClickListener {
                ...
                val intent = Intent(mContext, MaintenanceManagementBreakdownRequestDetailActivity::class.java)
                intent.putExtra("request_id", (breakdownRequestList[holder.adapterPosition].id).toString())

                sharedpreferences!!.setValue("request_id", (breakdownRequestList[holder.adapterPosition].id).toString())
            ...
            holder.itemView.setOnClickListener {
                ...
                val intent = Intent(mContext,MaintenanceManagementMaintenanceRequestDetailActivity::class.java)
                intent.putExtra("request_id", (breakdownRequestList[holder.adapterPosition].id).toString())
        ...
        else if (type.equals("preventive")) {
            holder.itemView.setOnClickListener {

                val intent = Intent(mContext,MaintenanceManagementPreventiveRequestDetailActivity::class.java)
                intent.putExtra("request_id", (breakdownRequestList[holder.adapterPosition].id).toString())
