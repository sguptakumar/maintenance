...
class MaintenanceMangerCommentAdapter(val mContext: Context?, val licenceList: ArrayList<Comment>) : RecyclerView.Adapter<MaintenanceMangerCommentAdapter.MyViewHolder>() {
