...
class ManagementMangerCommentAdapter(val mContext: Context?, val licenceList: ArrayList<Comment>) : RecyclerView.Adapter<ManagementMangerCommentAdapter.MyViewHolder>() {
