...
class MaintenanceManagerOrederPartAdapter(val mContext:Context?, val licenceList: ArrayList<com.appgenesis.com.maintenanceapp.operation_manager.model.OrderPart>):RecyclerView.Adapter<MaintenanceManagerOrederPartAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, p1: Int): MaintenanceManagerOrederPartAdapter.MyViewHolder {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, parent: Int) {
