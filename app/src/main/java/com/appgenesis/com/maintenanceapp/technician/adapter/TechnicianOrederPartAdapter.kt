...
class TechnicianOrederPartAdapter(val mContext:Context?, val licenceList: ArrayList<com.appgenesis.com.maintenanceapp.operation_manager.model.OrderPart>):RecyclerView.Adapter<TechnicianOrederPartAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, p1: Int): TechnicianOrederPartAdapter.MyViewHolder {
