...
import com.appgenesis.com.maintenanceapp.operation_manager.adapter.OperationManagerBreakdownRequestAdapter
...
class BreakDownRequestFragemntOperationManager : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recyclerView.adapter = OperationManagerBreakdownRequestAdapter(activity,operationManger,type)
        recyclerView.layoutManager  = LinearLayoutManager(activity!!)
    }

        companion object {
        fun newInstance(args: Bundle): BreakDownRequestFragemntOperationManager {
             val fragment = BreakDownRequestFragemntOperationManager()
