...
open class BreakDownTechnicianManagerParent: Fragment() {
    protected lateinit var adapter: TechnicianClosedRequestAdapter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter = TechnicianClosedRequestAdapter(activity, operationManger, type!!)
