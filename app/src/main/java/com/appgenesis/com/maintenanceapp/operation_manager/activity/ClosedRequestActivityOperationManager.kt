...
import kotlinx.android.synthetic.main.activity_closed_request_operation_manager.*

class ClosedRequestActivityOperationManager : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_closed_request_operation_manager)
